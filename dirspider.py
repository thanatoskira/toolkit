...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="DirBuster v{} - T00l for Web Directory Scan".format(DirBuster_version), version=DirBuster_version, usage='',fromfile_prefix_chars='@', epilog="Time to go~")
